  ...
  return (
    <div className="bg-gray-700 w-96 p-8 flex flex-col gap-6 rounded text-medium text-gray-100 border-2 border-gray-600">
      ...
      <form onSubmit={handleSubscriptionSubmit} className="flex flex-col gap-2">
        <input onChange={event => setName(event.target.value)} type="text" name="name" id="name" placeholder="Your name" className="p-4 bg-gray-700 rounded outline-none focus:ring-2 focus:ring-green-500" />
        <input onChange={event => setEmail(event.target.value)} type="email" name="email" id="email" placeholder="Your email" className="p-4 bg-gray-700 rounded outline-none focus:ring-2 focus:ring-green-500" />
      </form>
